...
from agent.neighbor_multi.orchestrator import (
...
async def run_neighbor_multi_eval(
    inputs: EvalInputs,
    ...
    try:
        async with eval_environment(
            ...
            return await run_neighbor_multi_agent_orchestration(
...
def create_neighbor_multi_eval_task(
    model_name: str | None = None,
    ...
    async def eval_task(
        ...
        return await run_neighbor_multi_eval(
            inputs,
            model_name=model_name,
            settings=settings,
        )
...
async def run_neighbor_multi_evals(
    ...
    task = create_neighbor_multi_eval_task(
        model_name,
        experiment_name,
        settings,
    )
