...
from agent.sandbox_budget_agent.prompts import DROP_THRESHOLD_PERCENT
...
def print_analysis_result(result: SuddenDropAnalysisResult) -> None:
    print("=" * 60)
    print("STELLARIS SUDDEN DROP ANALYSIS REPORT (SANDBOX)")
    print("=" * 60)
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Analyze Stellaris empire budget for sudden changes (sandbox version)",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  sandbox-budget-analyzer --save commonwealthofman_1251622081
  sandbox-budget-analyzer --save commonwealthofman_1251622081 --raw
  sandbox-budget-analyzer --save commonwealthofman_1251622081 --model openai:gpt-5.2-2025-12-11
        """,
    )
    ...
    if args.save:
        ...
        logfire.configure(
            service_name="stellaris-stats-sandbox-agent",
