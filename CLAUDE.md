...
| Analyze budget    | `npm run agent:analyze -- --type budget --save <filename> [--parallel]`                     |
| Analyze neighbors | `npm run agent:analyze -- --type neighbors --save <filename> [--agent-type single\|multi] [--parallel]` |
